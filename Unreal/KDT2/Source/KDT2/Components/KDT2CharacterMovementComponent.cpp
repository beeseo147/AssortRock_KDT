...
UKDT2CharacterMovementComponent::UKDT2CharacterMovementComponent()
{
	DefaultLandMovementMode = EMovementMode::MOVE_NavWalking;
}

void UKDT2CharacterMovementComponent::BeginPlay()
{
	Super::BeginPlay();
}

bool UKDT2CharacterMovementComponent::FindNavFloor(const FVector& TestLocation, FNavLocation& NavFloorLocation) const
{
	...
	const float SearchRadius = 0.f;// AgentProps.AgentRadius * 2.0f;
...
void UKDT2CharacterMovementComponent::PhysNavWalking(float deltaTime, int32 Iterations)
{

...
void AKDT2PlayerController::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AKDT2PlayerController::OnMove(const FInputActionValue& InputActionValue)
{
	...
	USkeletalMeshComponent* SkeletalMeshComponent = ControlledPawn->GetComponentByClass<USkeletalMeshComponent>();
